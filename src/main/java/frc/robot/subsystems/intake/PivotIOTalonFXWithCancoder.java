...
public class PivotIOTalonFXWithCancoder extends PivotIOTalonFX {
  ...
  public PivotIOTalonFXWithCancoder(int canId, String canBus, PivotTalonFXConstants constants) {
  ...
  private void seedMotorFromCancoder() {
    ...
    double cancoderRotations = absolutePositionSignal.getValueAsDouble();
