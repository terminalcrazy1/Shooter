...
public class Superstructure extends SubsystemBase {
    ...
    public static enum RequestCode {
        ...
        SUCCESS,
        /** This state doesn't have requirements, meaning it can't be requested.
         * This likely means it is a state used internally, rather a state that is meant to be requested externally. */
        CANNOT_REQUEST,
    ...
    private Map<SuperState, Trigger> stateTriggers = new HashMap<>(); // Triggers for when a state is entered or exited
    ...
    /**
     * Attempt to switch state to a requested state. Returns a request code informing whether it succeeded.
    ...
    /** Forcibly sets the current state to the specified state. Should only be used for resetting to IDLE or demo-ing
     * @param targetState The state to switch to
     */
