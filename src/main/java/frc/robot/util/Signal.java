...
public class Signal<EmitMessage> {
  public interface Observer<EmitMessage> {
   ...
   *
   * <p>If the `target` is a function, it will be called whenever this Signal emits a value.
   *
   * <p>If the `target` is a Signal, any emitted messages from this Signal will propagate to the
   * target Signal.
   *
